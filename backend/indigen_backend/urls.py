...
urlpatterns = [
    ...
    path('users/<int:user_id>/', user_views.get_user_details, name='get_user_details'),
    ...
    path('posts/<int:post_id>/increment-views/', user_views.increment_views, name='increment_views'),
